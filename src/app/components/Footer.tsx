...
export const Footer = () => {
  return (
    <div className='bg-[#90d0c2]'>
      <div className='pt-16 flex flex-col items-center text-darkDesaturatedCyan'>
        <div>
          <p className="font-extrabold text-3xl tracking-tight">sunnyside</p>
        </div>
        <div className='flex flex-row justify-between gap-16 font-medium p-8'>
          <div className='hover:text-white transition-all duration-300 cursor-pointer'>About</div>
          <div className='hover:text-white transition-all duration-300 cursor-pointer'>Services</div>
          <div className='hover:text-white transition-all duration-300 cursor-pointer'>Projects</div>
        </div>
        <div className='flex flex-row justify-between gap-5 p-8'>
          <svg
            className="w-5 h-5 fill-current hover:text-white transition-colors duration-300 cursor-pointer"
