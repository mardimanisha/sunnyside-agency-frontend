      ...
      <div className='flex flex-col items-center py-16 sm:py-10'>
        ...
        <div className='sm:flex sm:flex-row sm:justify-around sm:px-32'>
          <div className='flex flex-col items-center text-center p-8 sm:p-1'>
            <Image src={'/images/image-emily.jpg'} alt='profile image' height={80} width={80} className='rounded-full' />
          ...
          <div className='flex flex-col items-center text-center p-8 sm:p-1'>
            <Image src={'/images/image-thomas.jpg'} alt='profile image' height={80} width={80} className='rounded-full' />
          ...
          <div className='flex flex-col items-center text-center p-8 sm:p-1'>
            <Image src={'/images/image-jennie.jpg'} alt='profile image' height={80} width={80} className='rounded-full' />
